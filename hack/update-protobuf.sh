...
go build -o _output/bin/go-to-protobuf github.com/kube-all/public-cloud/vendor/k8s.io/code-generator/cmd/go-to-protobuf
go build -o _output/bin/protoc-gen-gogo github.com/kube-all/public-cloud/vendor/k8s.io/code-generator/cmd/go-to-protobuf/protoc-gen-gogo
